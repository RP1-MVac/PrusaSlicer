...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,
      brim_separation))((ConfigOptionEnum<BrimType>, brim_type))((ConfigOptionFloat, brim_width))((ConfigOptionBool, dont_support_bridges))((ConfigOptionFloat, elefant_foot_compensation))((ConfigOptionBool, adjust_layer_height_to_match))((ConfigOptionFloatOrPercent, extrusion_width))((ConfigOptionFloat, first_layer_acceleration_over_raft))(
